...
complex<double> phi_hes (double r,double q, double omega,double lamda,double nu_bar,double u_0,double eta,double rho);
...
double a(double r,double q,double T,double lamda,double nu_bar,double u_0,double eta,double rho);    //calculate the lower bound of the log-assest price
double b(double r,double q,double T,double lamda,double nu_bar,double u_0,double eta,double rho);    //calculate the upper bound of teh log-assear price
